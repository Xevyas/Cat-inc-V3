...
- Basic Trail occupies one cell and retains the internal persisted type ID `road`. Dragging the tool paints every crossed cell, including interpolated cells skipped by a fast pointer movement. Adjacent north/east/south/west trail tiles connect visually.
